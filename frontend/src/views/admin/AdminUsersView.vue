  ...
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      ...
      <button 
        ...
        class="px-4 py-2 bg-slate-950 hover:bg-slate-900 dark:bg-slate-100 dark:hover:bg-white dark:text-slate-950 text-white text-sm font-bold rounded-xl transition-colors shadow-sm"
      >
        + Register New User
      </button>
    </div>
